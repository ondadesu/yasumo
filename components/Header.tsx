    ...
    <header className="sticky top-0 z-50 w-full bg-white border-b border-[#f0f0ee] shadow-md">
      <div className="max-w-6xl mx-auto px-5 h-14 md:h-[80px] flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-1.5">
          <Link href="/project">
            <button className="flex items-center gap-1 whitespace-nowrap rounded-full px-3 md:px-[14px] py-[6px] text-[11px] font-semibold border border-black bg-black text-white hover:bg-white hover:text-black hover:border-black transition-all duration-150 cursor-pointer">
          ...
          <Link href="/register">
            <button className="flex items-center gap-1 whitespace-nowrap rounded-full px-3 md:px-[16px] py-[7px] text-[11px] font-bold border border-transparent bg-[#c3d60b] text-white hover:bg-white hover:text-[#c3d60b] hover:border-[#c3d60b] transition-all duration-150 cursor-pointer shadow-[0_1px_3px_#c3d60b55]">
              <span className="text-sm leading-none">＋</span>
