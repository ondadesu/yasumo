      ...
      <main className="min-h-screen bg-gray-100 p-6 z-10">
        ...
        <div className="max-w-md mx-auto space-y-6">
          ...
          <div className="bg-white p-6 rounded-xl border border-gray-200 shadow space-y-4 fade-left">
            ...
            <button onClick={() => setShowConfirm(true)} className="rounded-full w-full py-2 font-semibold cursor-pointer bg-[#c3d60b] text-white border border-transparent hover:bg-white hover:text-[#c3d60b] hover:border-[#c3d60b] transition">
              追加
            </button>
          </div>
